...
app = FastAPI(title="K-C FlowGuard — Real-Time Supply Chain Anomaly Predictor", version="0.1.0", lifespan=lifespan)
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "kc-flowguard-supply-chain-monitor"}
...
def index():
    ...
    return {"service": "kc-flowguard-supply-chain-monitor", "docs": "/docs"}
